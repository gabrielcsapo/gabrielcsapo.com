...
slug: /posts/thoughts-hardware-with-a-face-building-projects-with-interactivity
...
> The one thing that I have come by so far that kind of hits all the marks is [https://lvgl.io/developers](https://lvgl.io/developers) ([https://github.com/lvgl/lvgl](https://github.com/lvgl/lvgl)). I haven't seen a good set of demos for the cards that I am using so that might be something I look into trying to write about in the future.
...
![This is an example of what is rendered when using PIP-Arduino-Web-Browser. For more details, visit the source at [https://hackaday.io/project/3116-pip-arduino-web-browser](https://hackaday.io/project/3116-pip-arduino-web-browser).](./images/925351412462195167-1.jpeg)
