...
import ReadingDataSketchSource from "!!raw-loader!./files/reading_data_sketch.ino";
import BasicWebServerSketchSource from "!!raw-loader!./files/reading_data_sketch.ino";
