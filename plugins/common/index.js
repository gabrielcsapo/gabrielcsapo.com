...
export function getFrontMatter(filePath) {
        ...
        return (ast, vfile) => {
          ...
          visit(ast, "text", (node) => {
            ...
            if (nodeSentences.length <= remainingSentences) {
              ...
              sentences = sentences.concat(nodeSentences.slice(0, remainingSentences));
  ...
  if (frontmatter.image) {
    const absoluteImagePath = path.resolve(path.dirname(filePath), frontmatter.image);
    frontmatter.image = absoluteImagePath + "?w=300;500;700;900;1200&format=webp&as=picture";
  }

  if (frontmatter.layout) {
    frontmatter.layout = path.resolve(path.dirname(filePath), frontmatter.layout);
  } else {
